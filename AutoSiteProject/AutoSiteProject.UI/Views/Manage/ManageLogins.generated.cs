...
namespace ASP
{
    ...
    public partial class _Views_Manage_ManageLogins_cshtml : System.Web.Mvc.WebViewPage<AutoSiteProject.Models.ViewModels.ManageLoginsViewModel>
    {
...
WriteAttribute("title", Tuple.Create(" title=\"", 1737), Tuple.Create("\"", 1803)
, Tuple.Create(Tuple.Create("", 1745), Tuple.Create("Remove", 1745), true)
, Tuple.Create(Tuple.Create(" ", 1751), Tuple.Create("this", 1752), true)
            
            #line 40 "..\..\Views\Manage\ManageLogins.cshtml"
                                          , Tuple.Create(Tuple.Create(" ", 1756), Tuple.Create<System.Object, System.Int32>(account.LoginProvider
            
            #line default
            #line hidden
, 1757), false)
, Tuple.Create(Tuple.Create(" ", 1779), Tuple.Create("login", 1780), true)
, Tuple.Create(Tuple.Create(" ", 1785), Tuple.Create("from", 1786), true)
, Tuple.Create(Tuple.Create(" ", 1790), Tuple.Create("your", 1791), true)
, Tuple.Create(Tuple.Create(" ", 1795), Tuple.Create("account", 1796), true)
);
...
WriteAttribute("id", Tuple.Create(" id=\"", 2641), Tuple.Create("\"", 2667)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
, Tuple.Create(Tuple.Create("", 2646), Tuple.Create<System.Object, System.Int32>(p.AuthenticationType
...
WriteAttribute("value", Tuple.Create(" value=\"", 2684), Tuple.Create("\"", 2713)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
                                        , Tuple.Create(Tuple.Create("", 2692), Tuple.Create<System.Object, System.Int32>(p.AuthenticationType
...
WriteAttribute("title", Tuple.Create(" title=\"", 2714), Tuple.Create("\"", 2758)
, Tuple.Create(Tuple.Create("", 2722), Tuple.Create("Log", 2722), true)
, Tuple.Create(Tuple.Create(" ", 2725), Tuple.Create("in", 2726), true)
, Tuple.Create(Tuple.Create(" ", 2728), Tuple.Create("using", 2729), true)
, Tuple.Create(Tuple.Create(" ", 2734), Tuple.Create("your", 2735), true)
            
            #line 63 "..\..\Views\Manage\ManageLogins.cshtml"
                                                                                       , Tuple.Create(Tuple.Create(" ", 2739), Tuple.Create<System.Object, System.Int32>(p.Caption
            
            #line default
            #line hidden
, 2740), false)
, Tuple.Create(Tuple.Create(" ", 2750), Tuple.Create("account", 2751), true)
);
